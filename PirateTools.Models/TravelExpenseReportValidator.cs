...
public static class TravelExpenseReportValidator {
    public static IEnumerable<ReportIssue> ValidateReport(TravelExpenseReport_V1 report) {
    ...
    public static IEnumerable<ReportIssue> ValidateReportWarnings(TravelExpenseReport_V1 report) {
        yield break;
        //var vehicleCostStep = $"StepTravelCostsVehicle/{(int)report.VehicleUsed}";
    ...
    public static IEnumerable<ReportIssue> ValidateReportInfos(TravelExpenseReport_V1 report) {
        yield break;
